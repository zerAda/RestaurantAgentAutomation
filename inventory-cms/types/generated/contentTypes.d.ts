...
export interface ApiIngredientIngredient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    current_stock: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    min_stock_alert: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<10>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    supplier: Schema.Attribute.Relation<'manyToOne', 'api::supplier.supplier'>;
    unit: Schema.Attribute.Enumeration<['kg', 'g', 'l', 'ml', 'unit']> &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Menu items linked to inventory';
    displayName: 'Product';
    pluralName: 'products';
