...
STRAPI_KEYS="STRAPI_ADMIN_JWT_SECRET STRAPI_JWT_SECRET STRAPI_API_TOKEN_SALT STRAPI_TRANSFER_TOKEN_SALT STRAPI_ENCRYPTION_KEY STRAPI_APP_KEYS STRAPI_API_TOKEN_INTERNAL"
STRAPI_OK=1
