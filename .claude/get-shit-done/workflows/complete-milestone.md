...
```bash
ROADMAP=$(node "C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap analyze)
```
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node "C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract "$summary" --fields one_liner | jq -r '.one_liner'
done
```
...
```bash
ARCHIVE=$(node "C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/bin/gsd-tools.cjs" milestone complete "v[X.Y]" --name "[Milestone Name]")
```
...
**If doesn't exist:** Create from template at `C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/templates/retrospective.md`.
...
**Commit:**
```bash
node "C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update retrospective for v${VERSION}" --files .planning/RETROSPECTIVE.md
```
...
```bash
INIT=$(node "C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/bin/gsd-tools.cjs" init execute-phase "1")
