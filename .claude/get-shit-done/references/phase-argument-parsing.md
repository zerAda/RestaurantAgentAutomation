...
```bash
PHASE_INFO=$(node "C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
