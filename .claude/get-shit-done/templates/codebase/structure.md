...
- Usage: Reference from command with `@C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/mon pc/Desktop/ralphé_final_patch/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
