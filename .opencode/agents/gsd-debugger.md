...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/get-shit-done
                  → writes to C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
