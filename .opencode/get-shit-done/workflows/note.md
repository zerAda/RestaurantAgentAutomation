...
- **Global scope**: `C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/notes/`)
...
2. Glob `C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/mon pc/Desktop/ralphé_final_patch/.opencode/notes/` — works in any directory
