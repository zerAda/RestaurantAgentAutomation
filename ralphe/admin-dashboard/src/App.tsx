...
// SEC-P2-02: Lazy-load non-critical pages for faster initial load.
// Core ops pages (Dashboard, Stock, Kitchen) remain eager since they're used most.
      ...
      <div className={`min-h-screen bg-black text-zinc-100 font-sans selection:bg-brand-primary/30 relative overflow-hidden ${lang === 'ar' ? 'font-arabic' : ''}`}>
        ...
        <div className="relative z-10 min-h-screen flex flex-col md:flex-row">
          ...
          <main className={cn(
            ...
            <ErrorBoundary>
              <Suspense fallback={<div className="flex items-center justify-center h-64"><div className="w-8 h-8 border-2 border-brand-primary border-t-transparent rounded-full animate-spin" /></div>}>
              <Routes>
