...
/* ─────────── SessionStorage persistence (SEC-P1-05) ─── */
// SECURITY: Chat history may contain PII (customer names, order details).
// sessionStorage is tab-isolated and wiped on browser close, preventing
// PII leakage to subsequent users of the same device.
