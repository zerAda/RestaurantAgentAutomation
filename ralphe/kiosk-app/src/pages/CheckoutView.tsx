    ...
    const handleSubmitOrder = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                status: 'NEW',
                // SEC: total_cents is sent for display/logging only.
                // W_KIOSK_ORDER (n8n) MUST recalculate the total server-side
                // from item prices in Strapi. Never trust client-sent totals.
                total_cents: total,
